...
After loading the dataset and defining my DoKFold function (see [question 18](https://amanda-reed.github.io/DATA146/DATA146/midterm.html#question-18)), I created a dataframe containing the features and target of the data. To find the correlation 
