...
After loading the dataset and defining my DoKFold function (see [question 18](https://github.com/amanda-reed/DATA146/blob/main/midterm.md#question-18)), I created a dataframe containing the features and target of the data. To find the correlation 
